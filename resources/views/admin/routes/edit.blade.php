                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="flex flex-col p-2">
                            ...
                            <input type="text" name="name" id="name" class="border py-2 px-3 text-grey-700" placeholder="Name" value="{{ $route->name }}">
                        </div>
                        <div class="flex flex-col p-2">
                            ...
                            <select name="source_city_id" id="source_city_id" class="border py-2 px-3 text-grey-700">
                                @foreach ($cities as $city)
                                    <option value="{{ $city->id }}" {{ $city->id == $route->source_city_id ? 'selected' : '' }}>{{ $city->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="flex flex-col p-2">
                            ...
                            <select name="destination_city_id" id="destination_city_id" class="border py-2 px-3 text-grey-700">
                                @foreach ($cities as $city)
                                    <option value="{{ $city->id }}" {{ $city->id == $route->destination_city_id ? 'selected' : '' }}>{{ $city->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="flex flex-col p-2">
                            <label for="distance" class="mb-2 uppercase font-bold text-lg text-gray-700">Distance</label>
                            <input type="text" name="distance" id="distance" class="border py-2 px-3 text-grey-700" placeholder="Distance" value="{{ $route->distance }}">
                        </div>
                        <div class="flex flex-col p-2">
                            <label for="duration" class="mb-2 uppercase font-bold text-lg text-gray-700">Duration</label>
                            <input type="text" name="duration" id="duration" class="border py-2 px-3 text-grey-700" placeholder="Duration" value="{{ $route->duration }}">
                        </div>
                        <div class="flex flex-col p-2">
